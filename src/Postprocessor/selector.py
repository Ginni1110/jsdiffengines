...
if __name__ == '__main__':
    ...
    #             try:
    #                 st_new, br_new, fu_new, li_new = selector.istanbul_cover('./' + file)
    #                 st, br, fu, li = selector.set_coverage_values(st + st_new, br + br_new, fu + fu_new, li + li_new)
    #             except Exception:
    #                 pass
    #     break
    # print(st / 1000, br / 1000, fu / 1000, li / 1000)
